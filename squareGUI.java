...
public class squareGUI extends JComponent{
	...
	g2.setFont(new Font("Tahoma", Font.BOLD| Font.ITALIC, 25));
	g2.setColor(Color.black);
	g2.drawString("Hello, " + currentU.getUsername(), 60,60);
	g2.setFont(new Font("Helvetica", Font.PLAIN, 18));
	g2.drawString("let's see if you maintained your goals", 60,85);
